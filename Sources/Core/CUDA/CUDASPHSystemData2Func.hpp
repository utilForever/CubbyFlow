...
#ifndef CUBBYFLOW_CUDA_SPH_SYSTEM_DATA2_FUNC_HPP
#define CUBBYFLOW_CUDA_SPH_SYSTEM_DATA2_FUNC_HPP
...
class UpdateDensity
{
 public:
    ...
    inline CUBBYFLOW_CUDA_DEVICE void operator()(uint32_t i, float2 o, uint32_t,
                                                 float2 p)
    {
